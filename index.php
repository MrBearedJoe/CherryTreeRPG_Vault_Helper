...
if ($login_type == "mod" && in_array(base64_encode($login_as), $modPasswords)) include_once "./sections/_admin.php";
if ($login_type == "user" && isset($_GET['user'])) include_once "./sections/_user_pull.php";
